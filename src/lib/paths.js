...
module.exports = {
  ...
  appTsClientConfig: resolveApp("config/tsconfig.client.json"),
  appTsServerConfig: resolveApp("config/tsconfig.server.json"),
  appTsTestConfig: resolveApp("config/tsconfig.test.json"),
